...
export interface ApiLimitLimit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::limit.limit'> &
      Schema.Attribute.Private;
    machine: Schema.Attribute.Relation<'manyToOne', 'api::machine.machine'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    ...
    variables_of_consumption: Schema.Attribute.Relation<
      'manyToOne',
      'api::variables-of-consumption.variables-of-consumption'
    >;
  };
}
...
export interface ApiLogLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    unity: Schema.Attribute.Enumeration<['kWH', 'rpm']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    value: Schema.Attribute.String;
...
export interface ApiMachineMachine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    limits: Schema.Attribute.Relation<'oneToMany', 'api::limit.limit'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::machine.machine'
...
export interface ApiVariablesOfConsumptionVariablesOfConsumption
  extends Struct.CollectionTypeSchema {
  collectionName: 'variables_of_consumptions';
  info: {
    displayName: 'VariablesOfConsumption';
    pluralName: 'variables-of-consumptions';
    singularName: 'variables-of-consumption';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variable: Schema.Attribute.Enumeration<['rotations', 'energy']>;
  };
}
...
export interface ApiWarehouseWarehouse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    model3D: Schema.Attribute.Media<'files', true>;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
